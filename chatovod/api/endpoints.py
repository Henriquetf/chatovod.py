...
class APIEndpoint:
    """Endpoints for the Chatovod API."""
    host = 'chatovod.com'
    ...
    CHAT_ROOM_OPEN = Route(Method.POST, '/chat/openRoom')
    CHAT_ROOM_CLOSE = Route(Method.POST, '/chat/closeRoom')
    CHAT_PRIVATE_OPEN = Route(Method.POST, '/chat/openPrivate2')
    ...
    # User
    USER_CHAT_JOIN = Route(Method.POST, '/chat/auth')
